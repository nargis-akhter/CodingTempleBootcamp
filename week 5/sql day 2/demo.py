...
if __name__ == '__main__':
    create_tables(r'C:\Users\nargi\Documents\coding temple\week 5\sql day 2\movie theatre create.sql')
    insert_data(r'C:\Users\nargi\Documents\coding temple\week 5\sql day 2\movie theatre mock insert.sql')
