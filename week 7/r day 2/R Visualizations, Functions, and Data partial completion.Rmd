...
```{r}
# Filter information in the DF, where the month == 3, day ==31
...
# Select all columns from the flights dataset that start witht the letter c:
...
# Select all columns that match the gex expression fl|c
...
# geom_point(mapping=aes(columns we want vis))
```
...
```{r}
# Create a function that could conver celcius to far
# C * (9/5) + 32
